...
Plugin-gated provider features also live here. Extension capability helpers,
such as `withCaviControlOperatorCapabilities`, let a host app compose optional
product surfaces onto a provider capability snapshot without making provider
modules import extension contracts.
