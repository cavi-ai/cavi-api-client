...
const fallbackRuns: AgentRun[] = [
  {
    key: "agent:primary-operator:main",
    title: "Primary Operator Orchestrator",
    agentId: "primary-operator",
    channel: "discord",
  ...
  {
    key: "agent:qa-operator:subagent:20260309-1",
  ...
  {
    key: "agent:ui-operator:subagent:20260309-7",
  ...
  {
    key: "agent:backend-operator:backend:20260310-1",
    title: "Backend validation",
    agentId: "backend-operator",
    channel: "discord",
  ...
  {
    key: "agent:infra-operator:infra:20260310-2",
    title: "AKS reconcile",
...
export const fallbackAgentRuns: GatewaySessionRunsSnapshot = {
...
export function fallbackRunDetailForKey(key: string): GatewaySessionRunDetailSnapshot {
