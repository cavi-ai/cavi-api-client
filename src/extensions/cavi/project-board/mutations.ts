...
import type { createProjectBoardLiveHelpers } from "./live.js";

type ProjectBoardLiveHelpers = ReturnType<typeof createProjectBoardLiveHelpers>;
...
export function createProjectBoardMutations(
  ...
  return {
    ...
    createProjectBoardBacklogItem: async (draft: ProjectBoardBacklogDraft) =>
      withMutationResult({
    ...
    updateProjectBoardBacklogItem: async (itemId: string, draft: ProjectBoardBacklogDraft) =>
      withMutationResult({
    ...
    callProjectBoard: async (request: ProjectBoardCallRequest) =>
      withMutationResult({
        ...
        run: async () => {
          ...
          try {
            const response = await requestJson<ProjectBoardCallApiAckResponse>(
              PROJECT_BOARD_API.call,
              {
                method: "POST",
                body: payload,
