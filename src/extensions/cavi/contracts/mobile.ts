...
export const MOBILE_GATEWAY_ENDPOINT_CONTRACTS = {
  ...
  tradingDashboard: {
    ...
    note: "Trading portal snapshot: research packet cards, source folders, market-data recommendations, and source registry status. Mobile falls back to the checked packet-derived baseline until gateway exposes the workspace folder API.",
  },
  tradingResearchPackets: {
    ...
    owner: "trading gateway owner",
    note: "Thin packet-list endpoint for saved research packet folders under the trading workspace. Must preserve bearer auth and return structured packet metadata, not raw secret-bearing filesystem state.",
  },
  fleetLibrary: {
