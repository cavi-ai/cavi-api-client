import type { CostBucket, CostHistoryRange, CostHistorySnapshot } from "../../domain/index.js";
...
export function mockCostHistory(range: CostHistoryRange): CostHistorySnapshot {
