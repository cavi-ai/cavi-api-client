...
```ts
export declare function consumeSseStream(body: ReadableStream<Uint8Array>, signal: AbortSignal, onMessage: SseMessageHandler, options?: SseStreamOptions): Promise<void>;
```
...
<a id="symbol-core-sse-ssestreamoptions"></a>
