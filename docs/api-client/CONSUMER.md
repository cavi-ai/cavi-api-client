...
`0.13.0` release surface.

```text
source: docs/api-client/v0.13.0
publicBasePath: /docs/api-client/v0.13.0
...
The already-published npm package `@cavi-ai/api-client@0.13.0` does not contain
this subsequently generated documentation. Until a future package release
separately publishes it, copy the complete `docs/api-client/v0.13.0` directory
from this repository checkout or its CI documentation artifact to the host's
`/docs/api-client/v0.13.0` public base path. Serve `/docs/api-client` as an
...
The manifest version must equal the documented package version, `0.13.0`.
...
SHA-256 digest of the packed `@cavi-ai/api-client@0.13.0` authority artifact.
