...
| `createEmptyWorkerReady` | CAVI extension | keep | Declared by `src/extensions/cavi/operator-control/defaults.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `createEmptyWorkerTasks` | CAVI extension | keep | Declared by `src/extensions/cavi/operator-control/defaults.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
...
| `createProjectBoardLiveHelpers` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/live.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `createProjectBoardMutations` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/mutations.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
...
| `fallbackProjectBoardWorkspace` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/fallback.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
...
| `normalizeEmailAddress` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/normalize.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `normalizeEmailList` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/normalize.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `normalizeLimitations` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/normalize.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `normalizeProjectBoardBacklogItem` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/normalize.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `normalizeProjectBoardPriority` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/normalize.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `normalizeProjectBoardStatus` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/normalize.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `normalizeProjectBoardStorageMode` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/normalize.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `normalizeSection` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/normalize.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
...
| `OPERATOR_WORKER_TASK_SAMPLE_LIMIT` | CAVI extension | keep | Declared by `src/extensions/cavi/operator-control/constants.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
...
| `OperatorWorkerReadySnapshot` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/operator.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `OperatorWorkerTaskListSnapshot` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/operator.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `OperatorWorkerTaskRecord` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/operator.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `OperatorWorkerTaskState` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/operator.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
...
| `parseProjectBoardCallAck` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/normalize.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
...
| `PROJECT_BOARD_CANONICAL_AVATAR_CANDIDATES` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/constants.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `PROJECT_BOARD_FALLBACK_LIMITATIONS` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/constants.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardBacklogApiItemResponse` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/constants.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardBacklogApiResponse` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/constants.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardBacklogDraft` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/project-board.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardBacklogItem` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/project-board.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `projectBoardBacklogItemPath` | CAVI extension | keep | Declared by `src/extensions/cavi/contracts/paths.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardBacklogMutationPayload` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/live.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardBacklogPriority` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/project-board.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardBacklogSnapshot` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/project-board.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardBacklogStatus` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/project-board.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardCallApiAckResponse` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/constants.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardCallRequest` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/project-board.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardCallResult` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/project-board.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `projectBoardDraftToWorkboardCreate` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/workboard-adapter.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `projectBoardDraftToWorkboardPatch` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/workboard-adapter.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardEmailDraft` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/project-board.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardEmailRecipient` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/project-board.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardLiveHelpers` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/live.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardMutations` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/mutations.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `projectBoardPriorityToWorkboard` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/workboard-adapter.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardProfile` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/project-board.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardProfileApiResponse` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/constants.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardSprintApiResponse` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/constants.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardSprintStatus` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/project-board.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `projectBoardStatusToWorkboard` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/workboard-adapter.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardStorageMode` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/project-board.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `projectBoardWorkspaceDiagnosticRouteHint` | CAVI extension | keep | Declared by `src/extensions/cavi/contracts/paths.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `projectBoardWorkspaceExpectedContractSummary` | CAVI extension | keep | Declared by `src/extensions/cavi/contracts/paths.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `ProjectBoardWorkspaceSnapshot` | CAVI extension | keep | Declared by `src/extensions/cavi/domain/project-board.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
...
| `sortBacklogItems` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/normalize.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
...
| `toProjectBoardProfile` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/normalize.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `toProjectBoardWorkspaceFromCompatPayload` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/normalize.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `toProjectBoardWorkspaceSnapshot` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/normalize.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
...
| `workboardCardsToProjectBoardWorkspace` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/workboard-adapter.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `workboardCardToProjectBoardBacklogItem` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/workboard-adapter.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `workboardPriorityToProjectBoard` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/workboard-adapter.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
| `workboardStatusToProjectBoard` | CAVI extension | keep | Declared by `src/extensions/cavi/project-board/workboard-adapter.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep implementation and evolution under the CAVI extension. |
