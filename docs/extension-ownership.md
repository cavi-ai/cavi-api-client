...
| `createHermesRuntimeControlClient` | CAVI extension | keep | Declared by `src/extensions/cavi/providers/hermes/runtime-control.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep Hermes dashboard and CAVI plugin composition under the CAVI extension. |
...
| `HermesCaviRuntimeControlOptions` | CAVI extension | keep | Declared by `src/extensions/cavi/providers/hermes/runtime-control.ts`; TypeScript resolves this declaration through the CAVI barrel. | Keep provider-specific configuration out of core runtime-control options. |
...
| `normalizeTeamLookupValue` | core/contracts | already-core | Declared by `src/core/teams/directory.ts`; TypeScript resolves this declaration through the CAVI barrel. | Compose the canonical shared symbol; do not copy it into CAVI. |
