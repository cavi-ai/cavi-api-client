...
under `docs/api-client/v<package.json version>`.
...
| -------- | ------------ |
| Application integrators | [Online documentation](https://cavi-ai.xyz/docs/api-client) → [operation index source](docs/api-client/source/pages/operations/index.md) |
...
| Built artifact (immutable) | `docs/api-client/v<package.json version>/operations` |
| Start here | [`operations/index.md`](docs/api-client/source/pages/operations/index.md) |
| Symbol / type reference | [Online documentation](https://cavi-ai.xyz/docs/api-client) or the generated `reference/` directory |
...
| ------- | ------------------- |
| Universal runtime (runs, streaming, batch) | [`operations/runtime.md`](docs/api-client/source/pages/operations/runtime.md) |
...
| Gateway media and wiki | [`operations/gateway/media-wiki.md`](docs/api-client/source/pages/operations/gateway/media-wiki.md) |
| Gateway sessions and agent config | [`operations/gateway/sessions.md`](docs/api-client/source/pages/operations/gateway/sessions.md) |
| Gateway teams, kanban, and vault | [`operations/gateway/teams.md`](docs/api-client/source/pages/operations/gateway/teams.md) |
| Gateway WebSocket RPC methods | [`operations/gateway/rpc-methods.md`](docs/api-client/source/pages/operations/gateway/rpc-methods.md) |
| CAVI extension surfaces | [`operations/cavi/`](docs/api-client/source/pages/operations/cavi) |
| Concepts, transports, errors | [`concepts/`](docs/api-client/source/pages/concepts), [generated type reference](https://cavi-ai.xyz/docs/api-client) |
...
```sh
pnpm docs:check
DOCS_VERSION="v$(node -p 'require("./package.json").version')"
pnpm run docs:host-ingest-check -- --dir "docs/api-client/${DOCS_VERSION}"
```
