...
import { buildDocumentationInTemporaryRoot } from "../docs/build.mjs";
import { createReleaseEnvelope } from "./create-release-envelope.mjs";
import { normalizedRelativePath } from "../docs/paths.mjs";
import { resolveDocumentationRelease } from "../docs/types.mjs";
...
const HELP = `usage: pnpm run release:artifact -- --tarball <release.tgz> --output <directory> --version <semver> --tag <vsemver> --repository <owner/repo> --commit <sha> --npm-integrity <sha512-base64> --tarball-sha256 <sha256> [--root <repository>] [--source-date-epoch <seconds>] [--dry-run]
