...
const HELP = "usage: pnpm run release:envelope -- --version <stable-semver> --tag <vstable-semver> --repository cavi-ai/cavi-api-client --commit <40-char-sha> --artifact-sha256 <sha256>\n";
